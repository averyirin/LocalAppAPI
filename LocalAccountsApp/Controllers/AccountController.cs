...
namespace LocalAccountsApp.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        Look through 
            ...
            Accountant Table
            Admin Table
        Look for where the email matches the account
        ...
        isClient = contains.ClientInfo
        log them in to their portal.

        if(isClient && isAccountant)
            //show option to login into either
    */ 
